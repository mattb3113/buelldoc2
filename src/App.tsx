...
function App() {
  ...
  const [currentView, setCurrentView] = useState<'landing' | 'dashboard' | 'paystub-generator' | 'w2-generator' | 'bank-statement-generator' | 'certificates-generator'>('landing');
  ...
  if (currentView === 'dashboard' && isAuthenticated) {
    return (
      <Dashboard 
        ...
        onNavigateToBankStatement={() => setCurrentView('bank-statement-generator')}
  ...
  if (currentView === 'paystub-generator' && isAuthenticated) {
    return (
      <PaystubGenerator 
        ...
        onLogout={handleLogout}
        onNavigateToBankStatement={(paystubData) => {
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li>W-2 Forms</li>
                <li className="text-gray-500">Employment Letters (Coming Soon)</li>
                <li className="text-gray-500">Bank Statements (Coming Soon)</li>
              </ul>
            </div>
